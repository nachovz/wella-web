<div id="mainContent">
	<div id="play_video">
    	<iframe width="283" height="174" src="http://www.youtube.com/embed/FUiscdFTtvY?showinfo=0" frameborder="0" allowfullscreen></iframe>
    </div>
    <div id="texto">
    	<p>Wella's Stage es el nuevo formato del Trend Vision Award Venezuela 2012, inspirado en las cuatro tendencias de este año: Blaze, Grace, Roxy y Celeste. Es una competencia única, vanguardista y dedicada especialmente para todos los estilistas talentosos de Venezuela. </p>
        <p>Los semifinalistas vivirán durante los próximos 5 meses un grupo de retos que les permitirán clasificar para la gran final en donde sólo un selecto grupo podrá llegar. Serán asesorados por los mejores, por los expertos miembros del Team Artístico de Wella (TAW).</p>
